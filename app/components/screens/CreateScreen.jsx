  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="px-4 pt-6 pb-40 max-w-4xl mx-auto">
        <h1 className="text-xl md:text-2xl font-bold text-white/90 text-center drop-shadow-sm">
          客製你的專屬 AI 小管家
        </h1>
        <p className="text-xs md:text-sm text-white/60 text-center mt-2">
          用底部介面依序選顏色、個性、名字。
        </p>
      ...
      {/* 底部創角控制 */}
      <CompassCreator value={draft} onChange={(v) => setDraft(v)} onDone={onDone} disabled={false} />
    </main>
  );
}

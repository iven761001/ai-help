...
export default function WheelPicker({
  ...
  const applyIOSStyles = (scrollTop) => {
    ...
    for (let i = 0; i < itemElsRef.current.length; i++) {
      ...
      node.style.transform = `perspective(520px) rotateX(${rotateX.toFixed(2)}deg) translateZ(${translateZ.toFixed(1)}px) scale(${scale.toFixed(3)})`;

      node.style.color = fade > 0.82 ? "rgb(226 232 240)" : "rgba(226,232,240,0.70)";
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-white/5 px-3 py-3 glass-soft">
      <div className="px-1">
      ...
      <div className="mt-2 relative">
        <div
          ...
          className={cx(
            ...
            isInteracting
              ? "border-sky-300/40 bg-white/10 shadow-[0_0_0_1px_rgba(56,189,248,0.18),0_12px_30px_rgba(2,132,199,0.20)]"
        ...
        <style jsx>{`
          ...
          .gear-layer {
            ...
            inset: -28px;
            background:
              radial-gradient(circle at 50% 50%, rgba(56,189,248,0.16), rgba(255,255,255,0) 55%),
          ...
          .gear-sheen {
            ...
            opacity: calc(0.16 + var(--gearPulse, 0) * 0.26);
